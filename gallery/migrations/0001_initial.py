    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('art_type', models.CharField(choices=[('painting', 'Painting'), ('sculpture', 'Sculpture'), ('photograph', 'Photograph'), ('installation', 'Installation'), ('ceramic', 'Ceramic'), ('mixed_media', 'Mixed Media')], max_length=20)),
